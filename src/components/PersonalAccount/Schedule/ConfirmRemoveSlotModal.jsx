...
const ConfirmRemoveSlotModal = ({ open, onClose, onConfirm, slot }) => {
  const intl = useIntl();
  if (!slot) {
    return null;
  }
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      <DialogTitle>
        {intl.formatMessage({ id: "confirmRemoveSlot" })}
      </DialogTitle>
      <DialogContent>
        <Typography>
          {intl.formatMessage({ id: "removeSlot" })}
...
export default ConfirmRemoveSlotModal;
