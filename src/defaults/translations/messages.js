const messages = {
  en: {
    ...
    "header.lessons": "My Lessons",
    "header.schedule": "Schedule",
    "header.messages": "Messages",
    "header.likes": "Favourites",
    "header.advertisements": "My advertisements",
  ...
  uk: {
    ...
    "header.lessons": "Мої заняття",
    "header.schedule": "Розклад",
    "header.messages": "Повідомлення",
    "header.likes": "Обрані",
    "header.feedback": "Відгуки",
    "header.advertisements": "Мої оголошення(для викладача)",
